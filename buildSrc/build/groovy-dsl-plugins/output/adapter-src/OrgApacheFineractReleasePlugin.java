...
/**
 * Precompiled org.apache.fineract.release script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class OrgApacheFineractReleasePlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_OrgApacheFineractRelease").asSubclass(BasicScript.class);
