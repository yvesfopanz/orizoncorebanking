...
/**
 * Precompiled org.apache.fineract.dependencies script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class OrgApacheFineractDependenciesPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_OrgApacheFineractDependencies").asSubclass(BasicScript.class);
